...
- 각 페이지는 React app, server entry, client hydration entry를 가진다.
- 공통 renderer가 page server entry를 로드하고, HTML/head/data를 `index.html`에
  주입하며, Vite manifest에서 운영 asset을 찾는다.
